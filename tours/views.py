...
departures = {"msk":"Из Москвы","spb":"Из Петербурга","nsk":"Из Новосибирска","ekb":"Из Екатеринбурга","kzn":"Из Казани"}
...
class MainPageView(View):
    def get(self, request, *args, **kwargs):
        return render(request, 'tours/index.html', context =
            ...
            'tour1' : tour1, 'tour2' : tour2, 'tour3' : tour3, 'tour4' : tour4, 'tour5' : tour5, 'tour6' : tour6,} )
...
class DepartureView(View):
    def get(self, request, departure_id, *args, **kwargs):
        ...
        return render(request, 'tours/departure.html', context = 
            { 'name': departure_name, 'departures' : departures, 
            'tour1' : tour1, 'tour2' : tour2, 'tour3' : tour3, 'tour4' : tour4, 'tour5' : tour5, 'tour6' : tour6,} )
...
class TourView(View):
    def get(self, request, tour_id, *args, **kwargs):
        ...
        return render(request, 'tours/tour.html', context = {'tour': tour, 'departure_name' : departure_name, })